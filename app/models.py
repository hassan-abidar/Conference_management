...
class Subject(models.Model):
    ...
    updated_at = models.DateTimeField(auto_now=True)
    pdf_file = models.FileField(upload_to='media/subject_pdfs', null=True, blank=True)  # Add the pdf_file attribute
...
class Attendance_Report(models.Model):
    participant_id = models.ForeignKey(Participant, on_delete=models.DO_NOTHING)
